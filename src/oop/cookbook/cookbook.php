...
$lemon_chicken->addIngredient("garlic, chopped", 2, "c. à soupe");
$lemon_chicken->addIngredient("lemon juice", .25, "Cup");
$lemon_chicken->addIngredient("sugar", .5, "c. à café");
$lemon_chicken->addIngredient("parsley", 2, "c. à café");
$lemon_chicken->addIngredient("oregano", 2, "c. à café");
$lemon_chicken->addIngredient("basil", 1, "c. à soupe");
...
$granola_muffins->addIngredient("vanilla", 1, "c. à café");
$granola_muffins->addIngredient("white vinegar", .5, "c. à café");
$granola_muffins->addIngredient("granola", 2, "cup");
$granola_muffins->addIngredient("flour", 1, "cup");
$granola_muffins->addIngredient("instant protein", 4, "c. à soupe");
$granola_muffins->addIngredient("baking powder", 2, "c. à café");
$granola_muffins->addIngredient("cinnamon", 2, "c. à café");
$granola_muffins->addIngredient("baking soda", .5, "c. à café");
$granola_muffins->addIngredient("salt", .5, "c. à café");
...
$belgian_waffles->addIngredient("vanilla", 2, "c. à café");
$belgian_waffles->addIngredient("flour", 2, "cup");
$belgian_waffles->addIngredient("baking powder", 1, "c. à soupe");
...
$pepper_casserole->addIngredient("salt", 1, "c. à café");
...
$lasagna->addIngredient("Garlic, chopped", 4, "c. à soupe");
$lasagna->addIngredient("Tomato Sauce", 64, "once");
$lasagna->addIngredient("Sugar", 1, "c. à café");
$lasagna->addIngredient("Oregano", 2, "c. à soupe");
$lasagna->addIngredient("Parsley", 2, "c. à soupe");
$lasagna->addIngredient("Basil", 4, "c. à soupe");
...
$rabbit_catalan->addIngredient("Olive Oil", 4.5, "c. à café");
...
$rabbit_catalan->addIngredient("Parsley, finely chopped", 1.5, "c. à soupe");
...
$rabbit_catalan->addIngredient("Saffron threads", .25, "c. à café");
...
$grilled_salmon_with_fennel->addIngredient("Olive Oil", 2, "c. à café");
...
$grilled_salmon_with_fennel->addIngredient("Fresh parsley, finely chopped", 2.5, "c. à soupe");
$grilled_salmon_with_fennel->addIngredient("Fennel leaves, finely chopped", 5, "c. à café");
...
$pistachio_duck->addIngredient("Pistachios, finely chopped", 1.5, "c. à soupe");
...
$pistachio_duck->addIngredient("Shallots, minced", 1, "c. à café");
...
$chili_pork->addIngredient("Garlic, chopped", 2, "c. à café");
$chili_pork->addIngredient("Cilantro", 3, "c. à soupe");
$chili_pork->addIngredient("Chicken stock", 2, "cup");
$chili_pork->addIngredient("Lime Juice", 3, "c. à soupe");
$chili_pork->addIngredient("Red onion, diced", 3, "c. à soupe");
$chili_pork->addIngredient("Olive oil", 2, "c. à soupe");
...
$crab_cakes->addIngredient("Cilantro", 2, "c. à soupe");
...
$beef_medallions->addIngredient("Shallots", 1, "c. à soupe");
...
$beef_medallions->addIngredient("Black peppercorns", 1, "c. à café");
$beef_medallions->addIngredient("Bay leaf", 1);
$beef_medallions->addIngredient("Demi-glace or meat glaze", 5, "once");
$beef_medallions->addIngredient("Garlic, chopped", 1, "c. à café");
$beef_medallions->addIngredient("Butter", 1, "c. à café");
...
$silver_dollar_cakes->addIngredient("Salt", .5, "c. à café");
$silver_dollar_cakes->addIngredient("Baking soda", .5, "c. à café");
$silver_dollar_cakes->addIngredient("Cake flour", .25, "cup");
$silver_dollar_cakes->addIngredient("Sour cream", 2, "cup");
$silver_dollar_cakes->addIngredient("Sugar", 3, "c. à soupe");
...
$french_toast->addIngredient("Cinnamon", .5, "c. à café");
$french_toast->addIngredient("Nutmeg", .25, "c. à café");
...
$granola->addIngredient("Nutmeg", 1, "c. à café");
$granola->addIngredient("Cinnamon", .5, "c. à café");
$granola->addIngredient("Salt", .125, "c. à café");
...
$spicy_omelette->addIngredient("Butter", 2, "c. à soupe");
$spicy_omelette->addIngredient("Green chili pepper, seeded & diced", 2);
$spicy_omelette->addIngredient("Kielbasa sausage", 4, "once");
$spicy_omelette->addIngredient("Onion, diced", 3, "c. à soupe");
$spicy_omelette->addIngredient("Tomato concasse", 2, "c. à soupe");
$spicy_omelette->addIngredient("Eggs, beaten", 3);
$spicy_omelette->addIngredient("Pepper-Jack cheese, shredded", 3, "c. à soupe");
...
$scones->addIngredient("Baking powder", 2.5, "c. à café");
$scones->addIngredient("Salt", 1, "c. à café");
$scones->addIngredient("Baking soda", .5, "c. à café");
$scones->addIngredient("Orange zest", 1, "c. à soupe");
...
$scones->addIngredient("Orange juice, freshly squeezed", 4, "c. à café");
